    ...
    <Link to={`/movie/${movie.id}`}>
      <div className="group relative aspect-[2/3] overflow-hidden rounded-md">
        <img
          ...
          alt={movie.title}
        />
        <div className="absolute top-0 flex h-full w-full flex-col justify-end gap-1 bg-linear-to-b from-transparent via-transparent to-black p-6 group-hover:via-black/60">
